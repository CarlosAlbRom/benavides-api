...
let ImageController = class ImageController {
    ...
    uploadImage(images, text) {
        console.log(images);
        console.log(text);
        if (images) {
            return new response_model_1.APIResponse().success("ROUTE WOKS", images);
        }
        else {
...
ImageController = __decorate([
    ...
    __metadata("design:paramtypes", [typeof (_g = typeof image_service_1.ImageService !== "undefined" && image_service_1.ImageService) === "function" ? _g : Object])
], ImageController);
...
/******/ (() => {
/******/ 	__webpack_require__.h = () => ("1c0c8c00ed7675972220")
/******/ })();
/******/ 
/******/ }
;